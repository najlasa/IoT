...
DROP TABLE IF EXISTS att_log_temp;
CREATE TABLE `att_log_temp` (
  `sn` varchar(30) NOT NULL,
  `scan_date` datetime NOT NULL,
  `pin` varchar(32) NOT NULL,
  `verifymode` int(11) NOT NULL,
...
LOCK TABLES cuti_normatif WRITE;
INSERT INTO cuti_normatif VALUES
  (1, 'Cuti Hamil', 45, 0, 1),
...
INSERT INTO device VALUES
  ('FS1520195000002', '9B85C-147D-FA22E-DCFD-CA955-E9CF-B31FD', NULL, 'Mesin 1', 1, 0, '192.168.1.201', 1, 0, '0', '', '', '5005', 0, 10, 0, 0, '2021-10-14', '0', '0', '0', '', NULL, -1);
UNLOCK TABLES;
...
INSERT INTO dev_type VALUES
  ...
  (3, 33, 'Revo W-202BNC'),
  (3, 34, 'Revo WFA-207NC'),
  (3, 35, 'Revo WDV-204BNC'),
  (3, 36, 'Revo WFV-208BNC');
UNLOCK TABLES;

DROP TABLE IF EXISTS ganti_jdw_d;
CREATE TABLE `ganti_jdw_d` (
...
DROP TABLE IF EXISTS ganti_jdw_jk;
CREATE TABLE `ganti_jdw_jk` (
  `ganti_jdw_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS ganti_jdw_pegawai;
CREATE TABLE `ganti_jdw_pegawai` (
...
DROP TABLE IF EXISTS ganti_jdw_pembagian;
CREATE TABLE `ganti_jdw_pembagian` (
  `ganti_jdw_id` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS ganti_jk;
CREATE TABLE `ganti_jk` (
...
DROP TABLE IF EXISTS ganti_jk_d;
CREATE TABLE `ganti_jk_d` (
  `ganti_jk_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS ganti_jk_pegawai;
CREATE TABLE `ganti_jk_pegawai` (
...
DROP TABLE IF EXISTS ganti_jk_pembagian;
CREATE TABLE `ganti_jk_pembagian` (
  `ganti_jk_id` int(11) NOT NULL DEFAULT '0',
  `pembagian1_id` int(11) NOT NULL DEFAULT '0',
  `pembagian2_id` int(11) NOT NULL DEFAULT '0',
  `pembagian3_id` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS grp_user_d;
CREATE TABLE `grp_user_d` (
...
LOCK TABLES grp_user_d WRITE;
INSERT INTO grp_user_d VALUES
...
DROP TABLE IF EXISTS grp_user_m;
CREATE TABLE `grp_user_m` (
...
DROP TABLE IF EXISTS index_ot;
CREATE TABLE `index_ot` (
...
DROP TABLE IF EXISTS jam_kerja_extra;
CREATE TABLE `jam_kerja_extra` (
...
DROP TABLE IF EXISTS jdw_kerja_m;
CREATE TABLE `jdw_kerja_m` (
  `jdw_kerja_m_id` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS jdw_kerja_pegawai;
CREATE TABLE `jdw_kerja_pegawai` (
...
LOCK TABLES jns_izin WRITE;
INSERT INTO jns_izin VALUES
  (10, 'Izin tidak masuk (Keperluan pribadi)', 0),
  (20, 'Izin pulang awal (Keperluan pribadi)', 0),
  (30, 'Izin datang terlambat (Keperluan pribadi)', 0),
  (40, 'Sakit dengan surat dokter', 0),
  (50, 'Sakit tanpa surat dokter', 0),
  (60, 'Izin meninggalkan tempat kerja', 0),
  (70, 'Izin dinas (Izin keperluan kantor)', 0),
  (71, 'Izin datang terlambat (Keperluan kantor)', 0),
  (72, 'Izin pulang awal (Keperluan kantor)', 0),
  (80, 'Cuti normatif', 0),
  (90, 'Cuti pribadi', 0),
...
LOCK TABLES kategori_izin WRITE;
...
DROP TABLE IF EXISTS pegawai_d;
CREATE TABLE `pegawai_d` (
  `pegawai_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS pegawai_status_pajak;
CREATE TABLE `pegawai_status_pajak` (
  `pegawai_id` int(11) NOT NULL,
...
LOCK TABLES pembagian1 WRITE;
INSERT INTO pembagian1 VALUES
  (1, 'Manager', ''),
  (2, 'Staff', ''),
  (3, 'Admin', '');
UNLOCK TABLES;
...
LOCK TABLES pembagian2 WRITE;
INSERT INTO pembagian2 VALUES
  (1, 'HRD', ''),
  (2, 'Keuangan', ''),
  (3, 'Penjualan', ''),
  (4, 'IT', '');
...
LOCK TABLES pembagian3 WRITE;
INSERT INTO pembagian3 VALUES
  (1, 'Head Office', ''),
  (2, 'Surabaya', ''),
  (3, 'Jakarta', ''),
  (4, 'Denpasar', ''),
...
DROP TABLE IF EXISTS pembulatan;
...
DROP TABLE IF EXISTS p_commands;
CREATE TABLE `p_commands` (
  `commands_sn` varchar(32) NOT NULL,
  `commands_number` int(11) unsigned NOT NULL,
...
INSERT INTO server VALUES
  (1, 'FingerspotCloud.Net', 'https://www.fingerspotcloud.net/'),
  (2, 'KitaCloud', 'https://www.kitacloud.com/'),
  (3, 'Fingerspot.net', 'https://www.fingerspot.net/'),
  (4, 'Fingerspot.IO', 'https://api.fingerspot.io/');
UNLOCK TABLES;

DROP TABLE IF EXISTS server_use;
CREATE TABLE `server_use` (
...
INSERT INTO setting VALUES
  ...
  ('hadir_cuti_bersama', '0', ''),
  ('hadir_cuti_normatif', '0', ''),
  ('hadir_cuti_pribadi', '0', ''),
  ('hadir_dinas', '-1', ''),
  ('hadir_sakit_surat_dokter', '0', ''),
  ('interval_habis_kontrak', '60', ''),
  ('is_cloud', '0', ''),
  ('jns_dl_auto', '2', ''),
  ('last_optimized', '2018-02-27', ''),
  ('late_tolerance', '0', ''),
  ('max_break', '60', ''),
  ('max_overtime', '', ''),
  ('max_overtime_t', '1440', ''),
  ...
  ('update_pembagian', '-1', ''),
  ('use_auto_proses', '-1', ''),
  ('use_auto_syn_dev_date', '-1', ''),
  ('use_index_ot', '0', ''),
  ('use_payroll_module', '0', ''),
  ('use_round', '0', ''),
  ('use_round_break', '0', ''),
  ('use_round_early', '0', ''),
  ('use_round_jk', '0', ''),
...
DROP TABLE IF EXISTS shift_result;
...
DROP TABLE IF EXISTS sync_detail;
...
DROP TABLE IF EXISTS sync_rekap;
CREATE TABLE `sync_rekap` (
  `pegawai_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS s_att_log;
CREATE TABLE `s_att_log` (
  `sn` varchar(30) NOT NULL,
  `scan_date` datetime NOT NULL,
  `pin` varchar(32) NOT NULL,
  `verifymode` int(11) NOT NULL,
...
CREATE TABLE `s_izin` (
  ...
  `kat_izin_id` int(11) DEFAULT '0',
  `ket_status` varchar(255) DEFAULT NULL,
  `action` int(1) NOT NULL DEFAULT '1' COMMENT '1:add, 2: edit, 3: delete',
  PRIMARY KEY (`pegawai_id`,`izin_tgl`,`izin_jenis_id`,`izin_status`,`izin_urutan`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
DROP TABLE IF EXISTS tmp_uareu;
CREATE TABLE `tmp_uareu` (
  `pin` varchar(32) NOT NULL,
  `finger_idx` tinyint(4) NOT NULL,
...
DROP TABLE IF EXISTS tukar_jam;
CREATE TABLE `tukar_jam` (
...
DROP TABLE IF EXISTS t_syn_temp;
CREATE TABLE `t_syn_temp` (
  `id` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


DROP TABLE IF EXISTS uareu_device;
CREATE TABLE `uareu_device` (
...
INSERT INTO user_log VALUES
  ('admin', '2021-10-14 11:43:00', 5, 1, '', 'Login user aplikasi \"admin\" '),
  ('admin', '2021-10-14 11:43:00', 5, 1, '', 'Login user aplikasi \"admin\" ');
UNLOCK TABLES;
...
INSERT INTO user_login VALUES
  ('admin', 'E5DDE9D8AD34B40E457D741FBC6EA04F', 1, '2021-10-14 00:00:00', 'admin'),
...
LOCK TABLES versi_db WRITE;
INSERT INTO versi_db VALUES
  (1, 'v.2014.05.07', ''),
  (2, 'v.2015.05.30', NULL),
  (3, 'v.2015.06.03', NULL),
  (4, 'v.2015.08.27', NULL),
  ...
  (14, 'v.2016.06.03', NULL),
  (15, 'v.2016.06.29', NULL),
  (16, 'v.2016.07.14', NULL),
  (17, 'v.2016.09.22', NULL),
  (18, 'v.2016.11.22', NULL),
  (19, 'v.2017.01.21', NULL),
  (20, 'v.2017.01.30', NULL),
  (21, 'v.2017.04.10', NULL),
  (22, 'v.2017.05.17', NULL),
  (23, 'v.2017.06.08', NULL),
  (24, 'v.2017.09.23', NULL),
  (25, 'v.2017.11.22', NULL),
  (26, 'v.2017.12.04', NULL),
  (27, 'v.2017.12.15', NULL),
  (28, 'v.2018.02.17', NULL),
  (29, 'v.2018.08.29', NULL),
  (30, 'v.2018.12.15', NULL),
  (31, 'v.2019.02.20', NULL),
  (32, 'v.2019.04.30', NULL),
  (33, 'v.2019.10.22', NULL),
  (34, 'v.2019.11.18', NULL),
  (35, 'v.2019.11.30', NULL),
  (36, 'v.2020.01.10', NULL),
  (37, 'v.2020.03.03', NULL),
  (38, 'v.2020.04.16', NULL),
  (39, 'v.2021.04.07', NULL);
UNLOCK TABLES;

DROP TABLE IF EXISTS zx_bayar_kredit;
CREATE TABLE `zx_bayar_kredit` (
...
DROP TABLE IF EXISTS zx_jns_krd;
CREATE TABLE `zx_jns_krd` (
...
DROP TABLE IF EXISTS zx_kredit_d;
CREATE TABLE `zx_kredit_d` (
  `id_kredit` int(11) NOT NULL,
  `no_urut` smallint(6) NOT NULL,
  `tgl_jt` date NOT NULL,
...
DROP TABLE IF EXISTS zx_kredit_m;
CREATE TABLE `zx_kredit_m` (
  `id_kredit` int(11) NOT NULL,
...
DROP TABLE IF EXISTS z_pay_com;
CREATE TABLE `z_pay_com` (
  `com_id` smallint(6) NOT NULL,
...
DROP TABLE IF EXISTS z_pay_grp;
CREATE TABLE `z_pay_grp` (
...
DROP TABLE IF EXISTS z_pay_grp_com;
CREATE TABLE `z_pay_grp_com` (
  `grp_id` smallint(6) NOT NULL,
  `com_id` smallint(6) NOT NULL,
...
DROP TABLE IF EXISTS z_pay_grp_emp;
CREATE TABLE `z_pay_grp_emp` (
  `grp_id` smallint(6) NOT NULL,
  `emp_id_auto` int(11) NOT NULL,
...
DROP TABLE IF EXISTS z_pay_money;
CREATE TABLE `z_pay_money` (
  `com_id` smallint(6) NOT NULL,
  `grp_id` smallint(6) NOT NULL,
  `emp_id_auto` int(11) NOT NULL,
...
DROP TABLE IF EXISTS z_pay_process_d;
CREATE TABLE `z_pay_process_d` (
...
DROP TABLE IF EXISTS z_pay_process_m;
CREATE TABLE `z_pay_process_m` (
  `process_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS z_pay_process_sd;
CREATE TABLE `z_pay_process_sd` (
  `process_id` int(11) NOT NULL,
  `no_urut` smallint(6) NOT NULL,
  `no_urut_ref` smallint(6) NOT NULL,
  `emp_id_auto` int(11) NOT NULL,
...
DROP TABLE IF EXISTS z_pay_report;
CREATE TABLE `z_pay_report` (
...
LOCK TABLES z_pay_report WRITE;
INSERT INTO z_pay_report VALUES
